<template>
    <div>
        ...
        <el-card>
            ...
            <!-- 步骤条区域 active只接受数字类型 用-0来实现隐士数据转换-->
            ...
            <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="100px" label-position='top'>
                <el-tabs :tab-position="'left'"  v-model="activeIndex" :before-leave='brforeTabLeave' @tab-click='tabClick'>
...
export default {
  ...
  methods: {
    ...
    brforeTabLeave (activeName, oldName) {
      console.log('即将离开的标签页名字是' + oldName)
    ...
    async tabClick () {
      ...
      if (this.activeIndex === '1') {
        ...
        if (res.meta.status !== 200) {
          return this.$message.error('获取静态属性数百')
        }
        console.log(res.data)
